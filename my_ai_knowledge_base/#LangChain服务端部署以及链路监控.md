...
## **非常好，这个问题问到 LangChain 的生产落地关键点——你从「模型调用」进阶到「系统级应用」的阶段了。**  
## **我们来系统讲解一下：**  
##   
...
## **LangChain 本身是一个框架，不是服务，所以部署时我们通常需要：**  
...
4️⃣** 访问：**  
## **登录 [https://smith.langchain.com](https://smith.langchain.com) 查看调用日志与链路。**  
